...
public class CustomerBean {
	...
	public CustomerBean(String name, String email, String phone1, String phone2, String state, String city, String adress,
			String pin, String created, String aliasName, String panNo, String gstNo, int active) {
		super();
